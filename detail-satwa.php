<?php
	...
	$satwa = mysqli_query($conn, "SELECT * FROM satwa WHERE id_satwa = '".$_GET['id']."' ");
	$p = mysqli_fetch_object($satwa);
?>
...
<html lang="en">
  <head>
    ...
    <!-- My Style -->
    <link rel="stylesheet" href="css/style-hewan.css" />
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 text-center mt-5">
                  <h2><?php echo $p->nama_binatang ?></h2>
                  <img src="<?php echo $p->gambar ?>" width="50%">
                  <h3>Fakta Menarik</h3>
                  <?php echo $p->deskripsi_satwa ?>
                </div>
            </div>
